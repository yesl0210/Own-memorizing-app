...
public class seeWord_Activity extends AppCompatActivity {
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seeword_main);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //추가 페이지로 가기
                Intent intent2 = new Intent(getApplicationContext(),createW_Activity.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == 1){ //
            if(resultCode == Activity.RESULT_OK) {
                ...
                insert_word(spelling,meaning);
                pagerAdapter.addPage(spelling,meaning); // spelling 은 어떻게 넣을지 고민
                Log.i("Insert Word","Word - Spelling: "+spelling+", Meaning: "+meaning);
            }
        }
    ...
    // 단어 추가
    // category_name text, spelling text, meaning text, wrong_N integer
    public void insert_word(String spelling, String meaning) {
    ...
    public void show_word(){
        ...
        while(c.moveToNext()){
            ...
            Log.i("Show Word","Word - Spelling: "+c.getString(0));
            Log.i("Show Word","Word - Meaning: "+c.getString(1));
            Log.i("Show Word","Word - category: "+c.getString(2));
